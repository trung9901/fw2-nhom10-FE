                        ...
                        <div className="tab-float">
                          ...
                          >
                            <div className="rte product_getcontent">
                              ...
                              <p>
                                Điện Thoại Honor 7X&nbsp;với thiết kế hiện đại
                                và cuốn hút, được làm bằng kim loại nhôm giúp
                                máy toát lên vẻ ngoài sang trọng. Máy khá mỏng
                                chỉ 7.6mm nặng khoảng 165g&nbsp;kết hợp với 4
                                góc được bo tròn nhẹ nên cảm giác cầm trên tay
                                điện thoại&nbsp;Honor 7X&nbsp;khá là thoải mái,
                                vừa vặn trong lòng bàn tay. Cùng với mặt kính
                                cường lực giúp tránh những va chạm không may xảy
                                ra khi sử dụng điện thoại, máy cũng được cấp
                                chuẩn IP67 về khả năng chống nước và bụi đảm bảo
                                an toàn, độ bền.
                              </p>
                              ...
                              <p>
                                Được trang bị màn hình kích thước 5.93 inch, độ
                                phân giải Full HD (1080 x 2160) pixels với tỉ lệ
                                hiển thị 18:9, trên tấm nền LTPS LCD mang lại
                                những hình ảnh sắc nét với màu sắc trung thực.
                                Nhờ tối ưu phần viền cực mỏng&nbsp;Honor 7X đưa
                                được một không gian hiển thị rộng đáp ứng hoàn
                                hảo nhu cầu xem phim, chơi game giải trí trên
                                màn hình lớn.
                              </p>
                              <h5>
                              ...
                              <p>
                                ...
                                diện người dùng EMUI 5.1 và có sức mạnh xử lý
                                được cung cấp bởi con chip HiSilicon Kirin 659,
                                8 nhân xung nhịp 2.3GHz với bộ nhớ RAM lên đến
                                4GB,&nbsp;Honor 7X&nbsp;thực hiện mọi tác vụ
                                nặng nhất một cách dễ dàng, từ lướt web, giải
                                trí, xem phim đến chơi mượt những tựa game đồ
                                họa nặng hiện nay. Bên cạnh đó, với bộ nhớ trong
                                64GB chiếc điện thoại Honor&nbsp;giúp người dùng
                                lưu trữ được rất nhiều dữ liệu cũng như thoải
                                mái chụp ảnh, quay video.
                              </p>
                            </div>
                          </div>
